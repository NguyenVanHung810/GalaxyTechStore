...
public class MyRewardsAdapter extends RecyclerView.Adapter<MyRewardsAdapter.Viewholder>{
    ...
    public void onBindViewHolder(@NonNull MyRewardsAdapter.Viewholder holder, int position) {
        ...
        String method = rewardModelList.get(position).getMethod();
        ...
        String coupanId=rewardModelList.get(position).getCoupenId();

        holder.setData(type, upperLimit, lowerLimit, method, body, validity, alreadyUsed, coupanId);
    }
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        public Viewholder(@NonNull View itemView) {
            ...
            coupanTitle = itemView.findViewById(R.id.coupen_title);
            coupanExpiryDate = itemView.findViewById(R.id.coupen_validity);
            coupanBody = itemView.findViewById(R.id.rewards_body);
        }
